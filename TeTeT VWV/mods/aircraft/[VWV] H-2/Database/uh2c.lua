...
uh2c.rotor_height 	= 1.0804	-- Front hub height in the 3D model itself, in its geographic coordinate frame (not from the ground!) [meters]
uh2c.MOI = {5800, 24800, 19800}	-- Increased inertia due to higher mass [Roll, Yaw, Pitch]

uh2c.RCS                = 12 	-- Slightly larger RCS due to more complex geometry
uh2c.IR_emission_coeff  = 0.4 	-- Two engines = more IR signature
...
return {
	Name 				=   'uh2c',
	DisplayName			= _('[VWV] UH-2C Seasprite'),
	DisplayNameShort	= _('UH-2C'),
	...
	attribute  			= {wsType_Air, wsType_Helicopter, wsType_Battleplane, WSTYPE_PLACEHOLDER ,"Transport helicopters",},
...
Pylons =     {
    ...
    rotor_animation = {
        ...
        rotor_models = {
            {
                modelRotorHub_EDM       = "sh2f_rotor_hub",
