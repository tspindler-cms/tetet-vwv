...
-- SCALED DOWN ~3.5% from UH-2A to account for removal of avionics mass
uh2b.MOI = {4920, 20100, 16200}	-- Previous: {5100, 20800, 16800}
...
return {
	Name 				=   'uh2b',
	DisplayName			= _('[VWV] UH-2B Seasprite'),
	DisplayNameShort	= _('UH-2B'),
	date_of_introduction= 1963.08,
