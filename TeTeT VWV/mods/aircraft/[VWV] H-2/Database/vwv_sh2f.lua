...
Pylons =     {
        pylon(1, 0, 0.00, 0.00, 0.00,
              ...
              FiX = 0, FiY = 0, FiZ = 0},
            {
                {   CLSID = "{SH2_MAD}",connector = "Pylon_1", attach_point_position = {0.0, 0.0, 0}}
            }
        ),
        pylon(2, 0, 0.00, 0.00, 0.00,
             ...
             FiX = 0, FiY = 0, FiZ = 0},
            {
                { CLSID = "{SH2_FUEL_TANK_120R}" , connector = "Pylon_2", attach_point_position = {0.0, 0.0, 0}}
            }
        ),
        pylon(3, 0, 0.00, 0.00, 0.00,
             ...
             FiX = 0, FiY = 0, FiZ = 0},
            {
                { CLSID = "{SH2_FUEL_TANK_120L}" , connector = "Pylon_3", attach_point_position = {0.0, 0.0, 0}}
            }
        ),
