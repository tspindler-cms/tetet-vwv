declare_plugin("jjj_uh2a",
{
    displayName = _("UH-2A Seasprite"),
    shortName = "UH-2A",
    installed = true,
    dirName = current_mod_path,

    encyclopedia_path = current_mod_path..'/Encyclopedia',
    fileMenuName = _("UH-2A Seasprite"),
    version = "2.2.0",
    state = "installed",
...
mount_vfs_texture_path  (current_mod_path.."/Textures/Seaspritea.zip")
mount_vfs_liveries_path (current_mod_path.."/Liveries")

dofile(current_mod_path..'/weapons/Uh2a_Ammo.lua')
add_aircraft(dofile(current_mod_path..'/Database/vwv_uh2a.lua'))
