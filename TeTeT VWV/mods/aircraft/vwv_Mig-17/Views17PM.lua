ViewSettings = {
	Cockpit = {
	[1] = {-- player slot 1
		CockpitLocalPoint      = {1.00, 1.365, 0.0},--Cockpit nach = vorne,hoch 4.705000,1.336000,0.000000
	...
	Chase = {
		LocalPoint      = {1.830,	0.70,	0},
		AnglesDefault   = {0.000000, 0.000000},
	}, -- Chase
	Arcade = {
		LocalPoint      =   {0.0,0.0,0.0},                              --  {-21.500000,6.618000,0.000000},
		AnglesDefault   = {0.000000,0.000000},
	}, -- Arcade
}
