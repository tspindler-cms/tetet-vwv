...
return {
    ...
    main_gear_pos           = { -2.0735, -1.64, 1.427 },
    ...
    SFM_Data = {
        aerodynamics = {
            ...
            table_data = {
                ...
                [8] = { 1.0,  0.0360, 0.050,  0.220,  0.20,   1.500,  11.0,   0.51 },
                [9] = { 1.1,  0.0380, 0.048,  0.200,  0.20,   1.500,  9.00,   0.32 },
                [10]= { 1.2,  0.0370, 0.045,  0.210,  0.20,   1.500,  8.00,   0.28 },
                [11]= { 1.3,  0.0350, 0.042,  0.230,  0.20,   1.500,  8.00,   0.26 },
                [12]= { 1.5,  0.0320, 0.037,  0.260,  0.20,   1.500,  8.00,   0.24 },
                [13]= { 1.8,  0.0300, 0.031,  0.300,  0.20,   1.500,  8.00,   0.24 },
                [14]= { 2.0,  0.0290, 0.029,  0.350,  0.28,   1.500,  8.00,   0.24 },
                [15]= { 2.2,  0.0290, 0.026,  0.400,  0.30,   1.500,  8.00,   0.23 },
                [16]= { 2.5,  0.0290, 0.022,  0.500,  0.32,   1.500,  5.25,   0.22 },
        ...
        engine = {
            ...
            dpdh_m          = 2900,         -- [N/km] Power loss altitude factor (Dry)
            dpdh_f          = 5100,         -- [N/km] Power loss altitude factor (Wet)

            table_data = {
                -- R-13-300 Thrust Profile
                -- Boosted supersonic values slightly to ensure Mach 2.0 capability
                --      M   Dry(N)  Wet(N)
                [1] = {0.0, 40800, 64000},
                [2] = {0.2, 36000, 58400},
                [3] = {0.4, 32000, 56500},
                ...
                [6] = {0.9, 38000, 76000},
                [7] = {1.0, 39000, 81700},
                [8] = {1.2, 36000, 89500},  -- Slight boost
                [9] = {1.4, 30000, 96000},  -- Smoothed curve
                [10] ={1.6, 24000, 102000}, -- R-13 peak efficiency area
                [11] ={1.8, 18000, 104000},
                [12] ={2.0, 14000, 106000},
                [13] ={2.2, 8000,  102000},
            },
    ...
    Damage = verbose_to_dmg_properties({
        ...
        ["NOSE_TOP_SIDE" ]      = {critical_damage = 3,  args = {151}},
        ...
        ["FRONT_WHEEL"]         = {critical_damage = 1,  args = {250}},
        ["LEFT_WHEEL"]          = {critical_damage = 1,  args = {251}},
        ["RIGHT_WHEEL"]         = {critical_damage = 1,  args = {252}},
        ["Line008"]             = {critical_damage = 1,  args = {253}},
        ["MAIN_LINE"]           = {critical_damage = 1,  args = {254}},
    }),
