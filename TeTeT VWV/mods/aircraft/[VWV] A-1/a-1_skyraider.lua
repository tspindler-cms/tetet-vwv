...
----------------------------------------------------------------------Pylons---------------------------------------------------------------------------------------------------------------
	...
	SFM_Data = {
        aerodynamics = -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
        {
            ...
            cy_flap        =    0.6,   -- 0.28,    -- coefficient, normal force, lift, flaps - very efficient flaps to allow for take-off with max weight
            cx_brk         =    0.06,   -- coefficient, drag, breaks
            table_data  =
            {
            --   M        Cx0        Cya        B        B4            Omxmax    Aldop    Cymax
				{0,      0.010,    0.117,     0.056,    0.000089,    0.25,    20,        0.1}, --0
				{0.1,    0.012,    0.162,     0.055,    0.000089,    0.85,    20,        0.2}, --76.7269mph
				{0.2,    0.013,    0.204,     0.055,    0.000089,    0.95,    20,        0.3}, --153.454 mph				
                {0.3,    0.014,    0.3163,    0.054,    0.000089,    1.25,    17,        0.6}, --230.2 mph
