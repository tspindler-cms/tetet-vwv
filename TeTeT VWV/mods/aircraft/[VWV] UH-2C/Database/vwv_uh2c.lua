...
Pylons =     {
        pylon(1, 0, 0.00, 0.00, 0.00,
             ...
             FiX = 0, FiY = 0, FiZ = 0},
            {
                { CLSID = "{UH2C_FUEL_TANK_120R}" , connector = "Pylon_1", attach_point_position = {0.0, 0.0, 0}}
            }
        ),
        pylon(2, 0, 0.00, 0.00, 0.00,
             ...
             FiX = 0, FiY = 0, FiZ = 0},
            {
                { CLSID = "{UH2C_FUEL_TANK_120L}" , connector = "Pylon_2", attach_point_position = {0.0, 0.0, 0}}
            }
        ),
