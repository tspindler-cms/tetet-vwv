	...
	SFM_Data = {
		aerodynamics = {			
			...
			table_data = {
                ...
                { 0.4,  0.022,  0.072, 0.170, 0.06, 1.600,  18.0,  1.15 },
                { 0.5,  0.023,  0.070, 0.180, 0.08, 1.600,  17.5,  1.12 },
                
                -- FIGHTING / CRUISE ZONE (Mach 0.6 - 0.7)
                { 0.6,  0.024,  0.050, 0.200, 0.10, 1.500,  17.0,  1.08 },
                { 0.7,  0.025,  0.050, 0.250, 0.12, 1.100,  16.5,  1.02 },

                -- TRANSONIC ACCELERATION (Mach 0.80)
                { 0.8,  0.027,  0.055, 0.220, 0.15, 0.600,  15.0,  0.94 }, 
                
                -- HIGH SPEED DASH (Mach 0.86)
                { 0.86, 0.026,  0.048, 0.350, 0.40, 0.400,  14.0,  0.80 },

                -- MACH "WALL" (Mach 0.9+)
                { 0.9,  0.026,  0.050, 0.450, 0.60, 0.250,  12.5,  0.80 },
                { 0.94, 0.029,  0.040, 0.500, 0.90, 0.150,  11.0,  0.72 }, 
                { 0.98, 0.060,  0.035, 0.600, 1.20, 0.100,  10.0,  0.65 },
