...
local vwv_mig17f = {
	...
	SFM_Data = {
		aerodynamics = {			
			Cy0					= 0.01,				-- [coeff] Zero AoA lift (Symm airfoil) (0.022?)
			...
			table_data = {
                ...
                { 0.3,  0.025,  0.072, 0.160, 0.05, 1.400,  18.0,  1.15 },
                { 0.4,  0.025,  0.072, 0.170, 0.06, 1.600,  18.0,  1.15 },
                { 0.5,  0.030,  0.070, 0.180, 0.08, 1.600,  17.5,  1.12 },
                
                -- ANTI-FLOAT ZONE (Mach 0.6 - 0.7)
                { 0.6,  0.040,  0.050, 0.200, 0.10, 1.500,  17.0,  1.08 },
                { 0.7,  0.045,  0.050, 0.250, 0.12, 1.100,  16.5,  1.02 },
