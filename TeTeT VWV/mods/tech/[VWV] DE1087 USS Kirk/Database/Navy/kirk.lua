...
-- USS Kirk 75 by James J. Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Kirk_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "kirk_dcs"  -- name of LODs lua
...
GT_t.LN_t.ship_mk42_127mm_AIR.PL[1] = {
							shell_name = {"vwv_kir_mk42_127mm_AIR"},
