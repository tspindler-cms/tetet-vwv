...
USS_Sumner_weapons:addLauncher(4, 1, ship_FMC5)
USS_Sumner_weapons:addLauncher(4, 2, ship_FMC5)

USS_Sumner_weapons:addTurret(5)
USS_Sumner_weapons:addLauncher(5, 1, ship_FMC5)
USS_Sumner_weapons:addLauncher(5, 2, ship_FMC5)

USS_Sumner_weapons:addTurret(6)
USS_Sumner_weapons:addLauncher(6, 1, ship_FMC5)
USS_Sumner_weapons:addLauncher(6, 2, ship_FMC5)
