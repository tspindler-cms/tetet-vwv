...
USS_TheSullivans_weapons:addLauncher(1, 1, ship_FMC5)
USS_TheSullivans_weapons:addLauncher(1, 2, ship_FMC5)

USS_TheSullivans_weapons:addTurret(2)
USS_TheSullivans_weapons:addLauncher(2, 1, ship_FMC5)
USS_TheSullivans_weapons:addLauncher(2, 2, ship_FMC5)

USS_TheSullivans_weapons:addTurret(3)
USS_TheSullivans_weapons:addLauncher(3, 1, ship_FMC5)
USS_TheSullivans_weapons:addLauncher(3, 2, ship_FMC5)

USS_TheSullivans_weapons:addTurret(4)
USS_TheSullivans_weapons:addLauncher(4, 1, ship_FMC5)
USS_TheSullivans_weapons:addLauncher(4, 2, ship_FMC5)

USS_TheSullivans_weapons:addTurret(5)
USS_TheSullivans_weapons:addLauncher(5, 1, ship_FMC5)

USS_TheSullivans_weapons:addTurret(6)
USS_TheSullivans_weapons:addLauncher(6, 1, ship_FMC5)

USS_TheSullivans_weapons:addTurret(7)
USS_TheSullivans_weapons:addLauncher(7, 1, ship_FMC5)
USS_TheSullivans_weapons:addLauncher(7, 2, ship_FMC5)

USS_TheSullivans_weapons:addTurret(8)
USS_TheSullivans_weapons:addLauncher(8, 1, automatic_gun_25mm)
