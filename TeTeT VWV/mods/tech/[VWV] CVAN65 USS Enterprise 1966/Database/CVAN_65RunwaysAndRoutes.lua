...
--[[
	...
	{{69.267, 19.55,     13.837 }, 	     	356.13, 		      88.6616, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{69.840, 19.55,     -9.158 }, 		    002.083, 		      88.571, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	{{-37.253, 19.55,   -20.290 }, 		    353.198, 	    	  87.7293 , 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 3 location
	{{-48.308, 19.55,   -33.250 }, 		    000.07, 		      95.2496, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 4 location
]]
	{{64.221, 19.55,     13.418 }, 	     	356.13, 		      88.6616, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{64.432, 19.55,     -9.331 }, 		    002.083, 		      88.571, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	{{-42.709, 19.55,   -20.004 }, 		    353.198, 	    	  87.7293 , 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 3 location
	{{-54.178, 19.55,   -33.234 }, 		    000.07, 		      95.2496, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 4 location
};
...
--    x				y        z			V_target
{
	...
	{ -- 1: 1st in six pack -> cat 2
		...
		{{ 34.0,	19.55,		   -8.7},  	2.0},
		{{50.0,       19.55,    -9.8427},        1.0},
		{{64.134,       19.55,    -9.361},        1.0}
}
	},
	{ RunwayIdx = 1, Points =
	{ -- 2: 2nd in six pack -> cat 1
		...
		{{  20.4,	19.55,		  -2.1},  	 2.0},
		{{  49.913,	19.55,    15.307},       1.0},
		{{64.294,       19.55,    13.702},       1.0}
	}
	},
	{ RunwayIdx = 3, Points =
	{ -- 3: 3rd in six pack -> cat 3
		...
		{{ -65.6,	19.55,		  -3.9},  	4.0},
		{{ -62.4,	19.55,		  -19.3},  	2.0},
		{{ -57.812,	19.55,		  -17.722},  	1.0},
		{{-43.054,       19.55,    -19.521},  	1.0}
	}
	},
	{ RunwayIdx = 4, Points =
	{ -- 4: 4th in six pack -> cat 4
		...
		{{ -65.4,	19.55,		  8.0},  	4.0},
		{{ -81.0,	19.55,		  -30.2},  	3.0},
		{{ -67.087,	19.55,		  -33.608},  	1.0},
		{{-56.025,       19.55,    -33.22},  	1.0}
	}
	},
	{ RunwayIdx = 1, Points =
