...
-- 72.5735 and 62.5735 are short, are working runway lengths
	{{62.221, 19.55,     13.418 }, 	     	356.12, 		      90.9403, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{62.432, 19.55,   -9.3259 }, 		    002.06, 		      90.8136, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	{{-44.709, 19.55,  -20.003 }, 		    353.13, 	    	  91.1863, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 3 location
	{{-56.178,  19.55,  -33.233 }, 		    000.0, 		    	  66.2523, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 4 location
};
...
--    x				y        z			V_target
{
	...
	{ -- 8th spot,
		...
		{{ -72.0,	19.55,		 13.0},  	3.0},
		{{ -72.0,	19.55,		 15.8},  	3.0},
		{{ -72.0,	19.55,		 32.8},		3.0, 60.0}
	},
	--{ -- 9th spot, onto port elevator.
	--	{{ 48.8,	19.55,		-25.0},  	6.0},
	--	{{ 58.0,	19.55,		 1.0},  	4.0},
	--	{{ 59.0,	19.55,		-33.4},  	-3.0, 60.0}  -- Should be despawining?
	--},
}
