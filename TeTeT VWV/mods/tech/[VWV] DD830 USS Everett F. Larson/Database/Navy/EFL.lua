...
-- USS Everett F. Larson 67 by James J Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/EFL_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "EFL_dcs"  -- name of LODs lua
...
GT.Length = 119.3 -- deck length I think
...
GT.Landing_Point = {-34.25,	5.961, 0};

-- smoke density and position
GT.exhaust = {
	[1] = { size = 0.60, pos = {6.65, 16.5, 0}},
	[2] = { size = 0.60, pos = {-12.021, 14.839, 0}}
};
...
GT_t.LN_t.ship_mk12_127mm_AIR.PL[1] = {
	shell_name = {"vwv_EFL_mk12_127mm_AIR"},
...
GT.Name = "USS Everett F Larson" -- folder name for Liveries
GT.DisplayName = _("[VWV] DD-830 USS Everett F. Larson") -- name in game in ME and on the tape at the bottom
GT.DisplayNameShort = _("Gearing class FRAM II") -- Label name
GT.Rate = 2200.000000 
