...
USS_Laffey_weapons:addLauncher(1, 1, ship_FMC5)
USS_Laffey_weapons:addLauncher(1, 2, ship_FMC5)

USS_Laffey_weapons:addTurret(2)
USS_Laffey_weapons:addLauncher(2, 1, ship_FMC5)
USS_Laffey_weapons:addLauncher(2, 2, ship_FMC5)

USS_Laffey_weapons:addTurret(3)
USS_Laffey_weapons:addLauncher(3, 1, ship_FMC5)
