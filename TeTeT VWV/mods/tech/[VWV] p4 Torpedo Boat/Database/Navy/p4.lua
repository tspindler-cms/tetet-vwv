...
-- Twin DShK, same WS layout as the PBR bow guns (those do play)
ws = GT_t.inc_ws();
GT.WS[ws] = {};
...
GT.WS[ws].LN[1].PL[1].shell_name = {"Utes_12_7x108_T", "Utes_12_7x108", "Utes_12_7x108", "Utes_12_7x108", "Utes_12_7x108"};
GT.WS[ws].LN[1].PL[1].shell_display_name = "12.7mm";
GT.WS[ws].LN[1].PL[1].shot_delay = 0.08;
GT.WS[ws].LN[1].PL[1].ammo_capacity = 2000;
GT.WS[ws].LN[1].distanceMax = 1200;
GT.WS[ws].LN[1].max_trg_alt = 500;
GT.WS[ws].LN[1].BR =
					{
						{
