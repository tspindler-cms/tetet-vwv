...
-- Vietnam Junk by James J. Jackson
-- Special thanks to Marlboros
...
GT.Name = "Junk"; -- folder name for Liveries
GT.DisplayName = _("[VWV] Vietnam Junk"); -- name in game in ME and on the tape at the bottom
GT.DisplayNameShort = _("Junk"); -- Label name
GT.Rate = 300.000000;
GT.riverCraft = true;
GT.draft = 0.20;
