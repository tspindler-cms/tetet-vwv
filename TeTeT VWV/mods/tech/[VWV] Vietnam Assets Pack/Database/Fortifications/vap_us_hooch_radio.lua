...
GT.visual.shape = "vap_us_hooch_radio";
GT.visual.shape_dstr = "vap_us_hooch_radio";
...
-----------------------------------------------------------------------------------------------------
GT.Name = "vap_us_hooch_radio";
GT.DisplayName = _("VAP US Hooch Radio");
GT.DisplayNameShort = _("Hooch Radio")
GT.Rate = 5;
