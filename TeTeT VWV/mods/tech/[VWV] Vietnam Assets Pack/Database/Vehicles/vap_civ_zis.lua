-- VAP Civil zis, truck based on HL pickup with DShK by ED --
...
GT.visual.shape = "vap_civ_zis_150";
...
-----------------------------------------------------------------------------------------------------
GT.Name = "vap_civ_zis_150";
GT.DisplayName = _("VAP Civilian Zis 150");
GT.DisplayNameShort = _("Civ Zis")
GT.Rate = 5;
