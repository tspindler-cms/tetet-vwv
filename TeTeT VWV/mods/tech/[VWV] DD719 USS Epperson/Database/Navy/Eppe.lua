...
-- USS Epperson 66 by James J Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Eppe_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "Eppe_dcs"  -- name of LODs lua
...
GT.Name = "USS Epperson" -- folder name for Liveries
GT.DisplayName = _("[VWV] DD-719 USS Epperson") -- name in game in ME and on the tape at the bottom
GT.DisplayNameShort = _("Gearing class FRAM I") -- Label name
GT.Rate = 2200.000000 
