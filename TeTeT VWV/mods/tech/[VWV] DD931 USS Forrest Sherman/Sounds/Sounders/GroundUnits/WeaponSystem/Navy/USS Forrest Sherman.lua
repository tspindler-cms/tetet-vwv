...
USS_Forrest_Sherman_weapons:addLauncher(1, 1, ship_FMC5)
USS_Forrest_Sherman_weapons:addLauncher(1, 2, ship_FMC5)

USS_Forrest_Sherman_weapons:addTurret(2)
USS_Forrest_Sherman_weapons:addLauncher(2, 1, ship_FMC5)
USS_Forrest_Sherman_weapons:addLauncher(2, 2, ship_FMC5)

USS_Forrest_Sherman_weapons:addTurret(3)
USS_Forrest_Sherman_weapons:addLauncher(3, 1, ship_FMC5)
USS_Forrest_Sherman_weapons:addLauncher(3, 2, ship_FMC5)
