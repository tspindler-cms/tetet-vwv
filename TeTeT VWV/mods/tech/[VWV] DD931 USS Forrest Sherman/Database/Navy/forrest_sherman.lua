...
-- USS Forrest Sherman 67 by James J. Jackson
...
GT.visual = {}
GT.visual.shape = "forrest_sherman_dcs"  -- name of LODs lua
...
GT_t.LN_t.ship_mk42_127mm_AIR.PL[1] = {
							shell_name = {"vwv_forrest_mk42_127mm_AIR"},
...
GT_t.LN_t.ship_mk33_76mm_AIR.PL[1] = {
							shell_name = {"vwv_forrest_mk33_76mm_AIR"},
...
GT.DisplayNameShort = _("F.Sherman class"); -- Label name
GT.Rate = 2800.000000;
