...
-- USS Laffey 64 by James J Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/laffey_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;
...
GT_t.LN_t.ship_mk12_127mm_AIR.PL[1] = {
	shell_name = {"vwv_laffey_mk12_127mm_AIR"},
...
GT_t.WS_t.ship_laffey_oerlikon_20mm = { name = "Laffey Oerlikon 20mm"};
GT_t.WS_t.ship_laffey_oerlikon_20mm.angles = {
	{math.rad(180), math.rad(-180), math.rad(-15), math.rad(85)},
};
GT_t.WS_t.ship_laffey_oerlikon_20mm.omegaY = math.rad(10); -- Block 1B
GT_t.WS_t.ship_laffey_oerlikon_20mm.omegaZ = math.rad(10); -- Block 1B
GT_t.WS_t.ship_laffey_oerlikon_20mm.pidY = {p=300, i = 0.05, d = 10.0, inn = 1000};
GT_t.WS_t.ship_laffey_oerlikon_20mm.pidZ = {p=300, i = 0.05, d = 10.0, inn = 1000};
GT_t.WS_t.ship_laffey_oerlikon_20mm.reference_angle_Z = 0;

GT_t.LN_t.ship_laffey_oerlikon_20mm_AIR = {};
GT_t.LN_t.ship_laffey_oerlikon_20mm_AIR.type = 3;
...
ws = GT_t.inc_ws();
GT.WS[ws] = {}
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.ship_laffey_oerlikon_20mm)
...
__LN = add_launcher(GT.WS[ws], GT_t.LN_t.ship_laffey_oerlikon_20mm_AIR);
__LN.sightMaxTanVel = 300;
...
GT.DisplayNameShort = _("USS Laffey") -- Label name
GT.Rate = 2235.000000 
