...
USS_Mullany_weapons:addLauncher(1, 1, ship_USN_125mm)
USS_Mullany_weapons:addLauncher(1, 2, ship_USN_125mm)

USS_Mullany_weapons:addTurret(2)
USS_Mullany_weapons:addLauncher(2, 1, ship_USN_125mm)
USS_Mullany_weapons:addLauncher(2, 2, ship_USN_125mm)

USS_Mullany_weapons:addTurret(3)
USS_Mullany_weapons:addLauncher(3, 1, ship_USN_125mm)
USS_Mullany_weapons:addLauncher(3, 2, ship_USN_125mm)

USS_Mullany_weapons:addTurret(4)
USS_Mullany_weapons:addLauncher(4, 1, ship_USN_125mm)
USS_Mullany_weapons:addLauncher(4, 2, ship_USN_125mm)
