...
-- USS Maddox TI by James J Jackson
...
GT.visual = {}
GT.visual.shape = "maddox_t_dcs"  -- name of LODs lua
...
GT_t.LN_t.ship_mk12_127mm_AIR.PL[1] = {
	shell_name = {"vwv_maddox_t_mk12_127mm_AIR"},
...
GT_t.LN_t.ship_mk33_76mm_AIR.PL[1] = {
	shell_name = {"vwv_maddox_t_mk33_76mm_AIR"},
	automaticLoader = false,
	shot_delay = 1.3333,
	ammo_capacity = 352,
};
...
GT_t.WS_t.ship_maddox_t_oerlikon_20mm.omegaY = math.rad(10); -- Block 1B
GT_t.WS_t.ship_maddox_t_oerlikon_20mm.omegaZ = math.rad(10); -- Block 1B
GT_t.WS_t.ship_maddox_t_oerlikon_20mm.pidY = {p=300, i = 0.05, d = 10.0, inn = 1000};
GT_t.WS_t.ship_maddox_t_oerlikon_20mm.pidZ = {p=300, i = 0.05, d = 10.0, inn = 1000};
...
ws = GT_t.inc_ws();
GT.WS[ws] = {}
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.ship_maddox_t_oerlikon_20mm)
...
__LN = add_launcher(GT.WS[ws], GT_t.LN_t.ship_maddox_t_oerlikon_20mm_AIR);
__LN.sightMaxTanVel = 300;
...
GT.DisplayNameShort = _("USS Maddox") -- Label name
GT.Rate = 2200.000000 
