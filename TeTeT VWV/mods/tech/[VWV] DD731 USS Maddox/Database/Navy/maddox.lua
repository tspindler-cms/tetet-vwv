...
GT_t.LN_t.ship_maddox_oerlikon_20mm_AIR.reactionTime = 6;
...
GT_t.LN_t.ship_maddox_oerlikon_20mm_AIR.reload_time = 20;
...
GT.DisplayName = _("[VWV] DD-731 USS Maddox") -- name in game in ME and on the tape at the bottom
