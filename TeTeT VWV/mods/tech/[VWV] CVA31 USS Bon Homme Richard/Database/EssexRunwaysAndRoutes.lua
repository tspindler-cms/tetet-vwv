...
GT.TaxiRoutes =
{
	{ -- 1 parking spot
		...
		{{ 120.000, 16.95, 13 },		-2.0,     0.0*0.0} -- Park . 1.0*60 = time for pilot to despawn 60 seconds, this is an option
	},
	{ -- 2 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 108.000, 16.95, -2 },		4.0},
		{{ 108.000, 16.95, 13 },		-2.0,    0.0*0.0 }
	},
	{ -- 3 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 96.000, 16.95, -2 },		4.0},
		{{ 96.000, 16.95, 13 },		-2.0,	0.0*0.0}
	},
	{ -- 4 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 84, 16.95, -2 },			4.0},
		{{ 84, 16.95, 13 },			-2.0,	0.0*0.0}
	},
	{ -- 5 parking spot
		{{ 19.574, 16.95, -5 }, 		6.0},
		{{ 70.000, 16.95, 0},           6.0},
		{{ 120.000, 16.95, -8}, 		4.0}, -- WP1
		{{ 120.000, 16.95, -14 },		-1.0, 0.0 * 0.0}
	},
	{ -- 6 parking spot
		{{ 19.574, 16.95, -5 }, 		6.0},
		{{ 70.000, 16.95, 0},           6.0},
		{{ 108.000, 16.95, -8 }, 		4.0}, -- WP1
		{{ 108.000, 16.95, -14 }, 		-1.0, 0.0 * 0.0} 
	},
	{ -- 7 parking spot
		{{ 19.574, 16.95, -5 }, 		6.0},
		{{ 70.000, 16.95, 0},           6.0},
		{{ 96.000, 16.95, -8.00 }, 	4.0}, -- WP1
		{{ 96.000, 16.95, -14 },       -1.0, 0.0 * 0.0}
	},
	{ -- 13 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 70.000, 16.95, 0},           6.0},
		{{ 120.000, 16.95, -2 },		4.0},
		{{ 120.000, 16.95, 0 },			-2.0,	0.0*0.0}
	},
	...
	{ -- 14 parking spot
		...
		{{ 70.000, 16.95, 0},           6.0},
		{{ 105.000, 16.95, -2 },		4.0},
		{{ 105.000, 16.95, 0 },			-2.0,	0.0*0.0}
	},
	{ -- 8 parking spot
		{{ 19.574, 16.95, -5 }, 		6.0},
		{{ 70.000, 16.95, 0},           6.0},
		{{ 84.000, 16.95, -8.00 }, 		4.0}, -- WP1
		{{ 84.000, 16.95, -14 }, 		-1.0, 0.0 * 0.0}
	},
	{ -- 9 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 72.000, 16.95, -2 },			4.0},
		{{ 72.000, 16.95, 13 },			-2.0,	0.0*0.0}
	},
	{ -- 10 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 60.000, 16.95, -2 },			4.0},
		{{ 60.000, 16.95, 13 },			-2.0,	0.0*0.0}
	},
	{ -- 11 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 48.000, 16.95, -2 },			4.0},
		{{ 48.000, 16.95, 13 },			-2.0,	0.0*0.0}
	},
	{ -- 12 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 36.000, 16.95, -2 },			4.0},
		{{ 36.000, 16.95, 13 },			-2.0,	0.0*0.0}
	},
	{ -- 15 parking spot
		{{ 7, 16.95, -5 }, 				6.0},
		{{ 70.000, 16.95, 0},           6.0},
