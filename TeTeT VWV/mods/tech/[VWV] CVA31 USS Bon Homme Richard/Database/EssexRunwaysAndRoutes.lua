...
{
	{ -- 1 parking spot
		{{ 29.792,	    16.95, -7.0379 }, 		6.0},
		{{ 128.61,  16.95, 6.85},		4.0}, 
		{{ 122.819, 16.95, 12.297}, -2.0,     0.0*0.0} 
	},
	{ -- 2 parking spot
		{{ 29.792,	    16.95, -7.0379}, 		6.0},
		{{ 116.61,  16.95, 6.85},		4.0},
		{{ 110.819, 16.95, 12.297}, -2.0,    0.0*0.0 }
	},
	{ -- 3 parking spot
		{{ 29.792,	    16.95, -7.0379},		6.0},
		{{ 104.61,  16.95, 6.85},		4.0},
		{{ 98.819,  16.95, 12.297},  -2.0,    0.0*0.0}
	},
	{ -- 4 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 92.61,  16.95, 6.85},			4.0},
		{{ 86.819, 	    16.95, 12.297},			-2.0,	0.0*0.0}
	},
	{ -- 5 parking spot
		{{ 7.0,     16.95, -5.7183}, 				6.0},
		{{ 80.61,  16.95, 6.85},			4.0},
		{{ 74.819,  16.95, 12.297},			-2.0,	0.0*0.0}
	},
	{ -- 6 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 66.61,  16.95, 6.85},			4.0},
		{{ 62.819,  16.95, 12.297},			-2.0,	0.0*0.0}
	},
	{ -- 7 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 55.164,  16.95, 6.85},			4.0},
		{{ 49.373,  16.95, 12.297},			-2.0,	0.0*0.0}
	},
	{ -- 8 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 39.636,  16.95, 6.85},			4.0},
		{{ 35.324,  16.95, 12.297},			-2.0,	0.0*0.0}
	},
	{ -- 9 parking spot
		{{ 29.792,	    16.95, -7.0379}, 		6.0},
		{{ 45.335,  16.95, -4.6165},           6.0},
		{{ 125.79,  16.95, -5.7266}, 		4.0},
		{{ 120.000, 16.95, 13.389},		-1.0, 0.0 * 0.0}
	},
	{ -- 10 parking spot
		{{ 29.792,	    16.95, -7.0379}, 		6.0},
		{{ 45.335,  16.95, -4.6165},           6.0},
		{{ 113.79,  16.95, -5.7266}, 		4.0},
		{{ 108.000, 16.95, 13.389}, 		-1.0, 0.0 * 0.0} 
	},
	{ -- 11 parking spot
		{{ 29.792,	    16.95, -7.0379}, 		6.0},
		{{ 45.335,  16.95, -4.6165},           6.0},
		{{ 101.79,  16.95, -5.7266}, 		4.0},
		{{ 96.000,  16.95, 13.389},       -1.0, 0.0 * 0.0}
	},

	{ -- 12 parking spot
		{{ 29.792,	    16.95, -7.0379 }, 		6.0},
		{{ 45.335,  16.95, -4.6165},           6.0},
		{{ 89.791,  16.95, -5.7266}, 		4.0},
		{{ 84.000,  16.95, 13.389}, 		-1.0, 0.0 * 0.0}
	},
	{ -- 13 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 77.195,  16.95,  -5.7266},		4.0},
		{{ 71.487,  16.95,  -13.957},			-2.0,	0.0*0.0}
	},
	{ -- 14 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 64.615,  16.95,  -9.3833},		4.0},
		{{ 58.907,  16.95,  -17.623},			-2.0,	0.0*0.0}
	},
	{ -- 15 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 51.747,  16.95,  -9.3833},		4.0},
		{{ 46.039,  16.95,  -17.623},			-2.0,	0.0*0.0}
	},
	{ -- 16 parking spot
		{{ 29.792,	    16.95, -7.0379}, 				6.0},
		{{ 38.305,  16.95,  -9.3833},		4.0},
