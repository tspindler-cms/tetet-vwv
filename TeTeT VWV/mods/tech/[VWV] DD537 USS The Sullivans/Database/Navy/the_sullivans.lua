...
GT_t.LN_t.ship_mk33_76mm_AIR.PL[1] = {
							shell_name = {"vwv_ts_mk33_76mm_AIR"},
							automaticLoader = false,
							shot_delay = 1.3333,
							ammo_capacity = 352,
						};

GT_t.WS_t.ship_sullivans_oerlikon_20mm = { name = "The Sullivans Oerlikon 20mm"};
GT_t.WS_t.ship_sullivans_oerlikon_20mm.angles = {
	{math.rad(180), math.rad(-180), math.rad(-15), math.rad(85)},
};
GT_t.WS_t.ship_sullivans_oerlikon_20mm.omegaY = math.rad(10); -- Block 1B
GT_t.WS_t.ship_sullivans_oerlikon_20mm.omegaZ = math.rad(10); -- Block 1B
GT_t.WS_t.ship_sullivans_oerlikon_20mm.pidY = {p=300, i = 0.05, d = 10.0, inn = 1000};
GT_t.WS_t.ship_sullivans_oerlikon_20mm.pidZ = {p=300, i = 0.05, d = 10.0, inn = 1000};
GT_t.WS_t.ship_sullivans_oerlikon_20mm.reference_angle_Z = 0;

GT_t.LN_t.ship_sullivans_oerlikon_20mm_AIR = {};
GT_t.LN_t.ship_sullivans_oerlikon_20mm_AIR.type = 3;
...
GT_t.LN_t.ship_sullivans_oerlikon_20mm_AIR.PL = {};
GT_t.LN_t.ship_sullivans_oerlikon_20mm_AIR.PL[1] = {
	shell_name = { "vwv_ts_oerlikon_20mm_AIR" },
	shot_delay = 0.1333,
...
__LN = add_launcher(GT.WS[ws], GT_t.LN_t.ship_mk33_76mm_AIR);
__LN.sightMaxTanVel = 300;
__LN.BR = {{ connector_name = 'POINT_GUN_76mm_3_2',
							recoilArgument = 33,
							recoilTime = 0.2 }};

ws = GT_t.inc_ws();
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.ship_sullivans_oerlikon_20mm);
GT.WS[ws].area = 'hull_engine_section';
...
__LN = add_launcher(GT.WS[ws], GT_t.LN_t.ship_sullivans_oerlikon_20mm_AIR);
__LN.sightMaxTanVel = 300;
__LN.BR = {
	{ 
		connector_name = 'POINT_GUN_20mm_1_1',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
	{ 
		connector_name = 'POINT_GUN_20mm_1_2',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
};
...
__LN.BR = {
	{ 
		connector_name = 'POINT_GUN_20mm_2_1',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
	{ 
		connector_name = 'POINT_GUN_20mm_2_2',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
};
...
__LN.BR = {
	{ 
		connector_name = 'POINT_GUN_20mm_3_1',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
	{ 
		connector_name = 'POINT_GUN_20mm_3_2',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
};
...
__LN.BR = {
	{ 
		connector_name = 'POINT_GUN_20mm_4_1',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
	{ 
		connector_name = 'POINT_GUN_20mm_4_2',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
};
...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.ship_sullivans_oerlikon_20mm );
GT.WS[ws].area = 'hull_rear_section';
...
GT.WS[ws].reference_angle_Y = math.rad(180);
GT.WS[ws].angles = {
	{math.rad(355), math.rad(5), math.rad(-5), math.rad(85)},
};
__LN = add_launcher(GT.WS[ws], GT_t.LN_t.ship_sullivans_oerlikon_20mm_AIR);
__LN.sightMaxTanVel = 300;
__LN.BR = {
	{ 
		connector_name = 'POINT_GUN_20mm_5_1',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
	{ 
		connector_name = 'POINT_GUN_20mm_5_2',
		recoilArgument = 33,
		recoilTime = 0.2 
	},
};
