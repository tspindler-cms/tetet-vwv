...
-- USS Radford 66 by James J. Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Radf_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "Radf_dcs"  -- name of LODs lua
...
GT.Landing_Point = {-28.799,	5.2426, 0};
...
--Damage Model
GT.DM = {
	{ area_name = "Hull", area_arg = 70, area_life = 1500},
	{ area_name = "T1", area_arg = 71, area_life = 300},
	{ area_name = "T2", area_arg = 72, area_life = 300},
	{ area_name = "T4", area_arg = 73, area_life = 300},
	{ area_name = "TPR", area_arg = 74, area_life = 100},
	{ area_name = "TPL", area_arg = 75, area_life = 100},
	{ area_name = "Mast", area_arg = 76, area_life = 200},
	{ area_name = "Bridge", area_arg = 77, area_life = 500},
...
GT_t.LN_t.ship_mk12_127mm_AIR.PL[1] = {
							shell_name = {"vwv_Radf_mk12_127mm_AIR"},
...
GT.Name = "USS Radford"; -- folder name for Liveries
GT.DisplayName = _("[VWV] DD-446 USS Radford"); -- name in game in ME and on the tape at the bottom
GT.DisplayNameShort = _("Fletcher class FRAM II"); -- Label name
GT.Rate = 2080.000000;
