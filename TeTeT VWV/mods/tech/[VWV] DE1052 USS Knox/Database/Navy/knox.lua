...
-- USS Knox 72 by James J. Jackson

GT = {};
dofile(current_mod_path..'/Database/scripts/Knox_RunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "knox_dcs"  -- name of LODs lua
...
GT.Name = "USS Knox"; -- folder name for Liveries
GT.DisplayName = _("[VWV] DE-1052 USS Knox"); -- name in game in ME and on the tape at the bottom
GT.DisplayNameShort = _("Knox class (DASH)"); -- Label name
GT.Rate = 3000.000000;
