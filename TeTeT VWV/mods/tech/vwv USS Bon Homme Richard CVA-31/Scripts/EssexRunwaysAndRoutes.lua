...
--	VppStartPoint; 		   azimuth (degree} 	  Length_Vpp; 	   Width_Vpp;
	{{-72.5916, 16.95, -5.60511}, 349.0,		   97.0, 			   20.0,  --somewhere between last wire and model center / just past last wire
...
-- runways/Cats inbetween Hold back start and connect to front of ship not where the cat/start point connectors are
	{{55.5750,  16.95,    9.332 }, 	     	000, 		    	  72.5735, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{55.6561,  16.95,  -11.781}, 		    002.4, 		    	  72.5735, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	};
...
GT.TaxiRoutes = 
{
	{ -- 1 parking spot
		...
		{{ -19.574, 16.95, 6.233 }, 6.0},
		{{ -58.441, 16.95, -4 },		4.0}, -- WP 4
		{{ -58.481, 16.95, 15 },		4.0,	0.5*60.0} -- Park . 1.0*60 = time for pilot to despawn 60 seconds, this is an option
	},
	{ -- 2 parking spot 
		{{ -10.574, 16.95, 6.233 }, 6.0}, -- (x axe pont, y hauteur pont, z coté - vers babord, + vers tribord), vitesse ------
		{{ -46.209, 16.95, -8 },		4.0},
		{{ -46.209, 16.95, 15 },		4.0,	0.5*60.0}
	},
	{ -- 3 parking spot
		{{ -4.4352, 16.95, -4.638 }, 6.0},
		{{ -32.7325, 16.95, -4 },		4.0},
		{{ -34.7325, 16.95, 15 },		4.0,	0.2*60.0}
	},
	{ -- 4 parking spot
		{{ -20.574, 16.95, 6.233 }, 6.0},
		{{ -22.112, 16.95, -8 },		4.0},
		{{ -22.112, 16.95, 15 },		4.0,	0.2*60.0}
	},
	{ -- 5 parking spot
		{{ -19.574, 16.95, 3.233 }, 6.0},
		{{ -10.101, 16.95, -8.00 }, 4.0}, -- WP1
		{{ -10.101, 16.95, 6 }, 		4.0, 0.1 * 60.0}
	},
	{ -- 6 parking spot
		{{ 15.574, 16.95, -10.233 }, 6.0},
		{{ 1.101, 16.95, -15.00 }, 4.0}, -- WP1
		{{ 1.101, 16.95, 3 }, 	  4.0, 0.1 * 60.0}
	},
	{ -- 7 parking spot
		{{ 25.574, 16.95, -5.233 }, 6.0},
		{{ 15.101, 16.95, -10.00 }, 4.0}, -- WP1
		{{ 15.101, 16.95, 3 }, 		4.0, 0.1 * 60.0}
	},
	{ -- 8 parking spot
		{{ 35.574, 16.95, -10.233 }, 6.0},
		{{ 22.101, 16.95, -10.00 }, 4.0}, -- WP1
		{{ 22.101, 16.95, 3 }, 		4.0, 0.1 * 60.0}
	}
}
