...
-- runways/Cats inbetween Hold back start and connect to front of ship not where the cat/start point connectors are
	{{55.5750,  17.004,    9.330 }, 	     	000, 		    	  72.5735, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{55.6561,  17.004,  -11.781}, 		    002.4, 		    	  72.5735, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	};
...
{		
 	{ RunwayIdx = 1, Points =
		{ -- 1 spawn 
			...
			{{40.5,	      17.004,      2.0},       2.0}, 
			{{41.5,	      17.004,      9.3},       2.0},
			{{47.0,	      17.004,    11.7},       1.0}, 
			{{50.0,       17.004,  11.730},       1.0}   
		}
	},
	{ RunwayIdx = 1, Points =
		{ -- 2 spawn 
	...
	{ RunwayIdx = 2, Points =
		{ -- 3 spawn 
			{{21.0,       17.004,    -16.0},       1.0},
			{{31.5,       17.004,    -16.0},       1.0},
			{{40.5,       17.004,    -12.0},       1.0}, 
 			{{45.5,       17.004,    -11.8},       1.0},
			{{50.0,       16.95,    -9.7},        1.0},
	...
	{ RunwayIdx = 2, Points =
		{ -- 4 spawn 
			...
			{{22.0,       17.004,    -25.0},       1.0},
			{{23.0,       17.004,    -16.0},       1.0},
			{{35.5,       17.004,    -13.0},       1.0},
			--{{40.5,       17.004,    -12.0},       1.0}, 
 			{{45.5,       17.004,    -11.781},       1.0},
			{{50.0,       16.95,   -11.781},        1.0},
 			{{51.0,       16.95,  -11.781},        1.0}  
		}
	},
	{ RunwayIdx = 1, Points =
		{ -- 5 spawn 
	...
	{ RunwayIdx = 1, Points =
		{ -- 29 spawn 
			{{-105.0,     16.95,      11.7},      1.0},
			{{-64.0,      16.95,      11.7},      1.0}, 
			{{-10.5,      16.95,       3.0},      1.0}, 
			{{40.5,	      16.95,       4.0},      2.0}, 
			{{43.0,	      16.95,       8.0},      2.0},
			{{47.0,	      17.004,    9.2},      1.0}, 
			{{50.0,       17.004,   9.230},      1.0} 
		}
	},
	{ RunwayIdx = 1, Points =
		{ -- 30 spawn 
